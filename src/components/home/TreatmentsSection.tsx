            ...
            <div className="relative">
              <div className="aspect-[4/5] rounded-3xl bg-paradise-gradient overflow-hidden relative">
                ...
                <div className="bokeh-container">
                  <div className="bokeh-particle w-24 h-24 top-[20%] left-[20%]" />
                  <div className="bokeh-particle w-32 h-32 bottom-[30%] right-[20%]" style={{ animationDelay: "2s" }} />
                </div>
                <div className="palm-shadow-overlay opacity-5" />

                {/* Content overlay */}
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center p-8">
                    <Sparkles size={64} className="text-primary mx-auto mb-4 animate-float" />
              ...
              {/* Floating card */}
              <div className="absolute -bottom-6 -left-6 bg-card rounded-2xl p-4 shadow-lg border border-border max-w-[200px]">
