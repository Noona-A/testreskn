...
const faqs = [
  ...
  { q: "Are online consultations effective?", a: "Yes! Many skin concerns can be effectively assessed via video consultation. Our pharmacist will provide personalised recommendations and ongoing support." },
