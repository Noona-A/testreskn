  ...
  <div className="min-h-screen bg-background">
    ...
    <main className="pt-24 pb-16">
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <p className="text-muted-foreground mb-8">Clinician assessment for prescription-strength treatments when over-the-counter options aren't enough. Treatment may include topical retinoids, antibiotics, or combination therapies.</p>
        ...
        <Button asChild className="btn-luxury text-primary-foreground">
          <a href="https://app.cal.eu/resknclinic/prescription-acne-assessment" target="_blank">Book Assessment</a>
        </Button>
      </div>
    </main>
    <Footer />
