              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <span className="text-muted-foreground">Windsor, Berkshire, UK</span>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@resknclinic.co.uk" className="text-muted-foreground hover:text-primary transition-colors">
